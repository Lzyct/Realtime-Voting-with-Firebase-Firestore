...
object Version {
    ...
    const val psMap = "17.0.0"
    const val psCore = "1.6.1"

    const val okhttpLog = "4.4.0"
...
object Android {
    const val applicationId = "com.tuxdev.protoviewer"
...
object PlayService {
    ...
    const val auth = "com.google.android.gms:play-services-auth:${Version.ps}"
    const val core = "com.google.android.play:core:${Version.psCore}"
}
...
object Extra {
    ...
    const val timeAgo = "com.github.marlonlom:timeago:4.0.1"
}